...
myContinents<-aggregate(cbind(pop,popgni) ~ kontinent,data=myData,sum)
...
treemap(myContinents,title="",index="kontinent", vSize="pop",vColor="kgni",type="value",palette="YlOrBr",aspRatio=2.5,position.legend="none",inflate.labels=T)
